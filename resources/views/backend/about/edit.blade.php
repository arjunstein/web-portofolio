                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <textarea name="summary" class="form-control @error('summary') is-invalid @enderror" id="summary"
                                                style="height: 100px">{{ $about->summary }}</textarea>
                                            @error('summary')
                                                <span class="invalid-feedback" role="alert">
                                                    <p>{{ $message }}</p>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="birthday" type="date"
                                                ...
                                                id="birthdate" value="{{ $about->birthday }}">
                                            @error('birthday')
                                                <span class="invalid-feedback" role="alert">
                                                    <p>{{ $message }}</p>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <select name="gender"
                                                ...
                                                <option {{ $about->gender == null ? 'selected disabled' : '' }}>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <textarea name="address" type="text" class="form-control @error('address') is-invalid @enderror" rows="3"
                                                id="Address">{{ $about->address }}</textarea>
                                            @error('address')
                                                <span class="invalid-feedback" role="alert">
                                                    <p>{{ $message }}</p>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="whatsapp" type="number"
                                                ...
                                                id="whatsapp" value="{{ $about->whatsapp }}">
                                            @error('whatsapp')
                                                <span class="invalid-feedback" role="alert">
                                                    <p>{{ $message }}</p>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="facebook" type="text"
                                                ...
                                                id="Facebook" value="{{ $about->facebook }}">
                                            @error('facebook')
                                                <span class="invalid-feedback" role="alert">
                                                    <p>{{ $message }}</p>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="instagram" type="text"
                                                ...
                                                id="Instagram" value="{{ $about->instagram }}">
                                            @error('instagram')
                                                <span class="invalid-feedback" role="alert">
                                                    <p>{{ $message }}</p>
                                                </span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="linkedin" type="text"
                                                ...
                                                id="linkedin" value="{{ $about->linkedin }}">
                                            @error('linkedin')
                                                <span class="invalid-feedback" role="alert">
                                                    <p>{{ $message }}</p>
                                                </span>
