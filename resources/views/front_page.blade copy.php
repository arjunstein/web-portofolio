                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card-body">
                            ...
                            <p style="text-align: justify;">
                                {{ isset($about->summary) ? $about->summary : 'Empty about' }}
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12">
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-sm-8">
                                    {{ isset($about->user->email) ? $about->user->email : 'Empty email' }}
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-sm-4">
                            ...
                            <div class="progress-container progress-primary">
                                ...
                                <div class="progress">
                                    <div class="progress-bar progress-bar-primary" data-aos="progress-full"
                                        ...
                                        style="width: {{ $skill->icon }}%">
                                    </div>
                                    <span class="progress-value">{{ $skill->icon }}%</span>
                                </div>
                            </div>
                        </div>
                        @empty
